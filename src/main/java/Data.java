public class Data {
    ...
    //Registration Data
    public static final String email = "vladegorov7788@gmail.com";
    public static final String password = "1234567";
    public static final String nickname = "vlad565";
    public static final String phone = "1234567";
    ...
    public static final String currentUrlMainPage = "https://romanceabroad.com/";
